...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8240919686:AAHmk3jbz89HwBiPTl5WM7_TWgLxtqwZEvQ")
API_ID = int(os.environ.get("API_ID", "23288569"))
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003087256440"))

FORCE_SUB_CHANNEL_1 = int(os.environ.get("FORCE_SUB_CHANNEL_1", "-1002911891707"))
